...
> Based on the repository [spigelli/mantine-storybook](https://github.com/spigelli/mantine-storybook)

You can find the storybook online [here](https://Alan-Gomes.github.io/mantine-storybook/)
...
const config: StorybookConfig = {
  ...
  refs: {
    'mantine': {
      title: 'Mantine',
      url: 'https://Alan-Gomes.github.io/mantine-storybook/',
